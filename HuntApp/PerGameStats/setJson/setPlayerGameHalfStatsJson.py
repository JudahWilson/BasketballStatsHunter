...
def setPlayersData(
    game, half, is_home, four_factors, team_stats_h, debug=False
) -> list:
    ...
    SP_pl_basic = team_stats_h.find("tbody").find_all("tr")
    # remove row that function as headers
    SP_pl_basic = [
...
def setPlayerGameHalfStatsJson(
    game, half, away_team_h, home_team_h, four_factors, debug=False
):
    """

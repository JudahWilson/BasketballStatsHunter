    ...
    while index < len(SP_pl_basic):
        ...
        if not pgs["played"]:
            ...
            if team_stats_advanced:
                ...
                pgs["true_shooting_percentage"] = DF_pl_advanced["TS%"]
                next_field = "effective_field_goal_percentage"
                pgs["effective_field_goal_percentage"] = DF_pl_advanced["eFG%"]
                ...
                pgs["free_throw_attempt_rate"] = DF_pl_advanced["FTr"]
                next_field = "offensive_rebound_percentage"
                pgs["offensive_rebound_percentage"] = DF_pl_advanced["ORB%"]
                next_field = "defensive_rebound_percentage"
                pgs["defensive_rebound_percentage"] = DF_pl_advanced["DRB%"]
                next_field = "total_rebound_percentage"
                pgs["total_rebound_percentage"] = DF_pl_advanced["TRB%"]
                next_field = "assist_percentage"
                pgs["assist_percentage"] = DF_pl_advanced["AST%"]
                next_field = "steal_percentage"
                pgs["steal_percentage"] = DF_pl_advanced["STL%"]
                next_field = "block_percentage"
                pgs["block_percentage"] = DF_pl_advanced["BLK%"]
                next_field = "turnover_percentage"
                pgs["turnover_percentage"] = DF_pl_advanced["TOV%"]
                next_field = "usage_percentage"
                pgs["usage_percentage"] = DF_pl_advanced["USG%"]
                next_field = "offensive_rating"
                pgs["offensive_rating"] = DF_pl_advanced["ORtg"]
                next_field = "defensive_rating"
                pgs["defensive_rating"] = DF_pl_advanced["DRtg"]

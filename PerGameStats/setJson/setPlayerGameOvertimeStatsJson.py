...
def setPlayersData(game, overtime, is_home, four_factors, team_stats_q) -> list:
    ...
    while index < len(SP_pl_basic):
        ...
        pgs["overtime"] = overtime

        # some don'tplay for an overtime
        if (
...
def setPlayerGameOvertimeStatsJson(
    game,
    overtime,
    away_team_q,
    home_team_q,
